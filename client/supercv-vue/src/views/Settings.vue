...
watch([config, keepText, keepImages, keepFileList], () => {
        ...
        <div v-else>
            <div class="setting-group">
                <div class="setting-item">
                    ...
                    <span class="config-value">当前值: {{ getDayLabel(config.expired_config.text) }}</span>
                </div>
                ...
                <div class="setting-item">
                    ...
                    <span class="config-value">当前值: {{ getDayLabel(config.expired_config.img) }}</span>
                </div>
                ...
                <div class="setting-item">
                    ...
                    <span class="config-value">当前值: {{ getDayLabel(config.expired_config.file) }}</span>
                </div>
            </div>
            ...
            <div class="setting-item preview-number">
                ...
                <span class="config-value">当前值: {{ config.preview_config.preview_number }}</span>
            </div>
        </div>
    </div>
</template>
